...
Follow.prototype.validate = async function(action) {
    ...
    if (action == "delete") {
        if (!doesFollowAlreadyExist) {this.errors.push("You're not following that user yet.")};
    };

    if (this.followedId.equals(this.authorId)) {this.errors.push("You cannot follow your own account.")}
};
